...
# df2 = df2[['지역별(1)','지역별(2)','2020.2/2.1']]
# df2 = df2.rename(columns = {'2020.2/2.1':'공장면적2020'})
# df2.loc[1] = ['지역별(1)','지역별(2)','2020']

# df2.loc[0, '공장면적2020'] = "2020"
...
df4 = df4[['소재지(시군구)별(1)','2020','2020.1']]
df4 = df4.drop([0]) 
df4 = df4.rename(columns={'소재지(시군구)별(1)':'지역별(1)','2020':'도시지역2020', '2020.1':'녹지지역2020'})
df4.insert(1, "지역별(2)", '소계', allow_duplicates=False)
df4.loc[1, '도시지역2020'] = "2020"
df4.loc[1, '녹지지역2020'] = "2020"
...
df8 = df8[['소재지(시군구)별(1)','소재지(시군구)별(2)','2020','2020.5']]
df8 = df8.drop([1]) 
df8 = df8.rename(columns={'소재지(시군구)별(1)':'지역별(1)','소재지(시군구)별(2)' : '지역별(2)','2020':'하천면적2020', '2020.5':'하천면적2020-1'})
df8.loc[2, '지역별(1)'] = "합계"
df8.loc[0, '하천면적2020'] = "2020"
...
df9 = df9[['시군구별(1)','시군구별(2)','2020.1']]
df9 = df9.rename(columns={'시군구별(1)':'지역별(1)','시군구별(2)' : '지역별(2)','2020.1':'흡연률2020'})
df9 = df9.drop_duplicates(['지역별(1)','지역별(2)'])
df9.loc[0, '흡연률2020'] = "2020"
df9 = df9.drop_duplicates(['지역별(1)','지역별(2)'])
...
df10 = df10[['행정구역별','2020']]
df10 = df10.rename(columns={'행정구역별':'지역별(1)','2020':'강수량2020'})
df10.insert(1, "지역별(2)", '소계', allow_duplicates=False)
df10.loc[0] = ['지역별(1)','지역별(2)','강수']
df10.loc[0, '강수량2020'] = "2020"
...
df13 = df13[['행정구역(시군구)별','2020.01 월']]
df13 = df13.rename(columns={'행정구역(시군구)별':'지역별(1)','2020.01 월':'유동인구2020'})
df13.insert(1, "지역별(2)", '소계', allow_duplicates=False)
df13 = df13.drop_duplicates(['지역별(1)'])
df13.loc[0] = ['지역별(1)','지역별(2)','강수']
df13.loc[0, '유동인구2020'] = "2020"
...
df15 = df15[['시도(1)','2020.2']]
df15 = df15.drop([1]) 
df15 = df15.rename(columns={'시도(1)':'지역별(1)','2020.2':'매립용량2020'})
df15.insert(1, "지역별(2)", '소계', allow_duplicates=False)
df15.loc[0, '지역별(2)'] = "지역별(2)"
df15.loc[0, '지역별(1)'] = "지역별(1)"
df15.loc[0, '매립용량2020'] = "2020"
...
# df16 = df16[['시도(1)','2020.3']]

# df16 = df16.drop([1]) 
# df16 = df16.rename(columns={'시도(1)':'지역별(1)','2020.3':'폐기물처리량2020'})
...
# df16.loc[0, '폐기물처리량2020'] = "2020"
# df16.loc[2, '폐기물처리량2020'] = "2020"
